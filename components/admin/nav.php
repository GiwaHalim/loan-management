      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item d-inline-block align-text-top">
            <a class="nav-link active" aria-current="page" href="/admin-pages/dashboards.php">
        ...
        <div class="d-flex me-5 align-items-center">
          <div class="mr-3 rounded d-flex ">
            <img src="../pictures/Ellipse 5.png" alt="" srcset="" class="rounded" width="60px">
          </div>
          <div class="ml-3 p-2 ">
            <!-- get user firstname and lastname from session -->
